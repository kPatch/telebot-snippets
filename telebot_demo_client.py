...
##########################################################
##########################################################
# tcp_serial_redirect.py MODIFIED To WORK as a client to
# send serial commands to LINUX machine
##########################################################
##########################################################
...
""")
    ...
    group.add_option("-p", "--port",
        ...
        #default = "COM31"
        # IRVIN: THE PORT FOR THE HMD IMU
        #default = "/dev/tty.SLAB_USBtoUART"
        default = "/dev/tty.usbserial-A9014D1T"
    ...
    group.add_option("-b", "--baud",
        ...
        # IRVIN: THE BAUDRATE FOR THE HMD IMU
        default = 38400 #Use when running regular ArduIMU code
	#default = 115200 #Use when running the improved ArduIMU code
    )
